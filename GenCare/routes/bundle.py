...
def get_user_bundle(email):
    ...
    try:
        ...
        personal = {
            ...
            "age": user['age'] or 30, # default if None
            "gender": user['gender'] or "Not Specified",
            "bloodType": user['blood_type'] or "Not Specified",
            "phone": user['phone'] or "",
        ...
        if lifestyle_row:
            lifestyle = {
                "activity": lifestyle_row.get('activity_level') or "Moderately",
                "diet": lifestyle_row.get('diet_type') or "Balanced",
                "smoking": lifestyle_row.get('smoking_status') or "Never",
